...
typedef struct i2c_intm  i2c_ts;
...
static VOID I2CISRHandleTxEmpty(IN	i2c_ts   *obj)
{
	...
	if (!obj->datalength) {
		...
		I2C_INTConfig(obj->I2Cint.I2Cx, (BIT_IC_INTR_MASK_M_TX_ABRT  | 
...
static VOID I2CISRHandleRxFull(IN  i2c_ts   *obj)
{
	...
	if(!obj->datalength){
		I2C_INTConfig(obj->I2Cint.I2Cx, (BIT_IC_INTR_MASK_M_RX_FULL |
...
HAL_Status RtkI2CInit(IN  i2c_ts  * obj1)
{
	i2c_ts *obj= obj1;

	obj->I2Cint.I2Cx = I2C_DEV_TABLE[0].I2Cx;

	InterruptRegister((IRQ_FUN) I2CISRHandle, I2C0_IRQ_LP, (u32) (obj), 7); /*IrqNum=6,I2C*/
	InterruptEn(I2C0_IRQ_LP, 7);

	/* I2C HAL Initialization */
	I2C_Init(obj->I2Cint.I2Cx, &I2CInitDat[0]);
...
void main(void)
{
	...
	I2CInitDat[i2cmaster.I2Cint.i2c_idx].I2CAckAddr =  MBED_I2C_SLAVE_ADDR0;
	I2CInitDat[i2cmaster.I2Cint.i2c_idx].I2CTXTL= 0x00;
	...
	I2CInitDat[i2cslave.I2Cint.i2c_idx].I2CMaster = I2C_SLAVE_MODE;
	RtkI2CInit(&i2cslave);
	...
	I2C_INTConfig(i2cslave.I2Cint.I2Cx, (BIT_IC_INTR_MASK_M_RX_FULL |
		BIT_IC_INTR_MASK_M_RX_OVER |
		BIT_IC_INTR_MASK_M_RX_UNDER),
		ENABLE);
...
void main(void)
{
	...
	i2cmaster.datalength=length;
	I2C_INTConfig(i2cmaster.I2Cint.I2Cx, (BIT_IC_INTR_MASK_M_RX_FULL |
		BIT_IC_INTR_MASK_M_RX_OVER |
		BIT_IC_INTR_MASK_M_RX_UNDER|BIT_IC_INTR_MASK_M_TX_ABRT),
		ENABLE);

	if(i2cmaster.datalength>1){
		I2C_MasterSend(i2cmaster.I2Cint.I2Cx, i2cmaster.pbuf,0x1,0, 0);
	...
	i2cslave.datalength=length;
	I2C_INTConfig(i2cslave.I2Cint.I2Cx, (BIT_IC_INTR_MASK_M_TX_ABRT |
		BIT_IC_INTR_MASK_M_TX_OVER |
		BIT_IC_INTR_MASK_M_RX_DONE |
		BIT_IC_INTR_MASK_M_RD_REQ),
		ENABLE);
