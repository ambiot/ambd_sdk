...
*/
//
// Color definitions in dependence of color format
//
#if (GUI_USE_ARGB)
  #define COLOR_RING0    0xFFCCCCCC
  #define COLOR_RING1    0xFF333333
  #define COLOR_SCALE0   0xFF111111
  #define COLOR_SCALE1   0xFF111111
  #define COLOR_DIGIT    0xFFCCCCCC
  #define COLOR_CMARK    0xFFCCCCCC
  #define COLOR_BACK0    0xFF3333FF
  #define COLOR_BACK1    0xFF000055
  #define COLOR_DISPLAY0 0xFF000000
  #define COLOR_DISPLAY1 0xFFCCCCCC
  #define COLOR_NEEDLE   0xFFFF8020
#else
  #define COLOR_RING0    0x00CCCCCC
  #define COLOR_RING1    0x00333333
  #define COLOR_SCALE0   0x00111111
  #define COLOR_SCALE1   0x00111111
  #define COLOR_DIGIT    0x00CCCCCC
  #define COLOR_CMARK    0x00CCCCCC
  #define COLOR_BACK0    0x00FF3333
  #define COLOR_BACK1    0x00550000
  #define COLOR_DISPLAY0 0x00000000
  #define COLOR_DISPLAY1 0x00CCCCCC
  #define COLOR_NEEDLE   0x002080FF
#endif
...
static GUI_MEMDEV_Handle _CreateRoundedRect(int xSize, int ySize, int r, U32 Color0, U32 Color1) {
  ...
  hMem            = GUI_MEMDEV_CreateFixed(0, 0, xSize << 2, ySize << 2, GUI_MEMDEV_NOTRANS, GUI_MEMDEV_APILIST_32, GUI_COLOR_CONV);
...
static GUI_MEMDEV_Handle _CreateReflex(int r, int dy, int a, U32 Color, U8 Intens) {
  ...
  xSize = ySize = r * 2 + 1;
  hMemGradient = GUI_MEMDEV_CreateFixed(0, 0, 64 * 2 + 1, 64 * 2 + 1, GUI_MEMDEV_NOTRANS, GUI_MEMDEV_APILIST_32, GUI_COLOR_CONV);
  //
  ...
  //
  hMemReflex = GUI_MEMDEV_CreateFixed(0, 0, (r << 1) + 1, (r << 1) + 1, GUI_MEMDEV_NOTRANS, GUI_MEMDEV_APILIST_32, GUI_COLOR_CONV);
  ...
  //
  GUI_MEMDEV_Select(hMemReflex);
  GUI_MEMDEV_DrawPerspectiveX(hMemGradient, 0, dy, ySize, ySize, xSize, 0);
  GUI_MEMDEV_Select(0);
  GUI_MEMDEV_Delete(hMemGradient);
  //
  // Rotate if required
  //
  if (a) {
    hMemRot = GUI_MEMDEV_CreateFixed(0, 0, (r << 1) + 1, (r << 1) + 1, GUI_MEMDEV_NOTRANS, GUI_MEMDEV_APILIST_32, GUI_COLOR_CONV);
...
static U32 _GetFontColor(int Speed, U32 Color0, U32 Color1) {
  ...
  if (hMem == 0) {
    hMem = GUI_MEMDEV_CreateFixed(0, 0, 10, 10, GUI_MEMDEV_NOTRANS, GUI_MEMDEV_APILIST_32, GUI_COLOR_CONV);
  }
  ...
  while (1) {
    ...
    for (; (tDiff = GUI_GetTime() - t0) < T_MAX;) {
      ...
      if (tDiff < (T_MAX >> 1)) {
        ...
        f = f * f * f;
        Param.Speed = 240 * f;
        Param.Angle = ((-30 + (240 - Param.Speed)) * 3.1415926f) / 180;
      }
      Param.FontColor = _GetFontColor((int)Param.Speed, COLOR_NEEDLE, GUI_WHITE);
      //
      // Rotate polygon
