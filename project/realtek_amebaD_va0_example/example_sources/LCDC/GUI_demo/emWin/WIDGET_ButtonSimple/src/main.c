...
int main(void)
{
	...
	if (xTaskCreate((TaskFunction_t )TouchTask,(const char*)"TouchTask", 1024, NULL, tskIDLE_PRIORITY + 1, NULL) != pdPASS)
		printf("\n\r%s xTaskCreate(TouchTask) failed", __FUNCTION__);
