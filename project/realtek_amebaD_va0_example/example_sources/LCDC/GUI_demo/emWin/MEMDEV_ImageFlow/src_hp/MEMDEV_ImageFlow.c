...
#if (GUI_USE_ARGB)
  #define COLOR_CONV &LCD_API_ColorConv_M8888I
#else
  #define COLOR_CONV &LCD_API_ColorConv_8888
#endif
...
**********************************************************************
*/
static GUI_CONST_STORAGE GUI_COLOR ColorsSegger_Logo_50x24[] = {
     GUI_MAKE_COLOR(0x0000FF),GUI_MAKE_COLOR(0xD9D9D9),GUI_MAKE_COLOR(0x0F0F0F),GUI_MAKE_COLOR(0xFF2929)
    ,GUI_MAKE_COLOR(0xFF0F0F),GUI_MAKE_COLOR(0x515356),GUI_MAKE_COLOR(0xFF0000),GUI_MAKE_COLOR(0x989A9C)
    ,GUI_MAKE_COLOR(0x090909),GUI_MAKE_COLOR(0xFFF0F0),GUI_MAKE_COLOR(0x212327),GUI_MAKE_COLOR(0xFCF9F9)
    ,GUI_MAKE_COLOR(0xDEBEBF),GUI_MAKE_COLOR(0xFF5252),GUI_MAKE_COLOR(0xFF8E8E),GUI_MAKE_COLOR(0xFFFFFF)
};

static GUI_CONST_STORAGE GUI_LOGPALETTE PalSegger_Logo_50x24 = {
  16,	// number of entries
  1, 	// Has transparency
  &ColorsSegger_Logo_50x24[0]
};

static GUI_CONST_STORAGE unsigned char acSegger_Logo_50x24[] = {
  
};

static GUI_CONST_STORAGE GUI_BITMAP bmSegger_Logo_50x24 = {
  50,                    // XSize
  24,                    // YSize
  25,                    // BytesPerLine
  4,                     // BitsPerPixel
  acSegger_Logo_50x24,   // Pointer to picture data (indices)
  &PalSegger_Logo_50x24  // Pointer to palette
};
...
*       _GetImages
*/
static int _GetImages(GUI_MEMDEV_Handle * phMem, GUI_MEMDEV_Handle * phMemNarrow, unsigned MaxItems) {
  GUI_JPEG_INFO Info;
  unsigned      i;
  ...
  */
  for (i = 0; (i < GUI_COUNTOF(_apData)) && (i < MaxItems); i++) {
    ...
    *(phMem + i) = GUI_MEMDEV_CreateFixed(0, 0, Info.XSize, Info.YSize, GUI_MEMDEV_NOTRANS, GUI_MEMDEV_APILIST_32, COLOR_CONV);
    if (*(phMem + i) == 0) {
      return 1;
    }
  ...
  GUI_MEMDEV_Select(0);
  /*
  * Create memory devices for the 6 narrow outer images
  */
  for (i = 0; i < 6; i++) {
    *(phMemNarrow + i) = GUI_MEMDEV_CreateFixed(0, 0, 60, 120, GUI_MEMDEV_NOTRANS, GUI_MEMDEV_APILIST_32, COLOR_CONV);
    if (*(phMemNarrow + i) == 0) {
      return 1;
    }
  }
...
*   Draws a memory device image perspectively into the current device
*/
...
static void _DrawScreenAnimated(GUI_MEMDEV_Handle * phMem, GUI_MEMDEV_Handle * phMemNarrow, int MaxItems, int Index) {
  ...
  int        aIndex[8];
  int        TimeStart;
  int        aTimeUsed[GUI_COUNTOF(_aParaL)];
  ...
  * Do screen animation
  */
  for (i = 0; i < (int)GUI_COUNTOF(_aParaL); i++) {
    GUI_SetClipRect(&_aRect[ScreenIndex]);
    TimeStart = GUI_GetTime();
    /*
    * On first iteration store outer images into memory devices
    * for later use
    */
    if (i == 0) {
      for (j = 0; j < 6; j++) {
    ...
    */
    ...
    /*
    * Draw 3 images at the left side
    */
    ...
    /*
    * Draw 3 images at the right side
    */
    ...
    */
    aTimeUsed[i] = GUI_GetTime() - TimeStart;
...
static void _DemoImageFlow(void) {
  ...
  if (_GetImages(ahMem, ahMemNarrow, GUI_COUNTOF(ahMem)) == 0) {
    ...
    GUI_DrawGradientV(0,   0, 319,  49, GUI_MAKE_COLOR(0x800000), GUI_MAKE_COLOR(0x800000));
    GUI_DrawGradientV(0,  30, 319,  49, GUI_MAKE_COLOR(0x800000), GUI_MAKE_COLOR(0xFFFFFF));
    GUI_DrawGradientV(0, 220, 319, 239, GUI_MAKE_COLOR(0xFFFFFF), GUI_MAKE_COLOR(0x800000));
    GUI_DrawGradientV(0,   0 + 240, 319,  49 + 240, GUI_MAKE_COLOR(0x800000), GUI_MAKE_COLOR(0x800000));
    GUI_DrawGradientV(0,  30 + 240, 319,  49 + 240, GUI_MAKE_COLOR(0x800000), GUI_MAKE_COLOR(0xFFFFFF));
    GUI_DrawGradientV(0, 220 + 240, 319, 239 + 240, GUI_MAKE_COLOR(0xFFFFFF), GUI_MAKE_COLOR(0x800000));
    GUI_DispStringHCenterAt("emWin-ImageFlow Demo", 190,   6);
    GUI_DispStringHCenterAt("emWin-ImageFlow Demo", 190, 246);
    GUI_DrawBitmap(&bmSegger_Logo_50x24, 6,   6);
    GUI_DrawBitmap(&bmSegger_Logo_50x24, 6, 246);
    Index = 0;
    do {
