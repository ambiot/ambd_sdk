...
static void _cbBkWindow(WM_MESSAGE * pMsg) {
  ...
  case WM_PAINT:
    ...
    GUI_DrawGradientV(0, 0, xSize, ySize, GUI_MAKE_COLOR(0xFF8080), GUI_MAKE_COLOR(0x8080FF));
...
static void _cbDialogSelect(WM_MESSAGE * pMsg) {
  ...
  case WM_PAINT:
    ...
    GUI_DrawGradientV(Rect.x0, Rect.y0, Rect.x1, Rect.y1, GUI_MAKE_COLOR(0x8080FF), GUI_MAKE_COLOR(0xFF8080));
    break;
  case WM_INIT_DIALOG:
...
static void _cbDialogOrder(WM_MESSAGE * pMsg) {
  ...
  case WM_INIT_DIALOG:
    ...
    EDIT_SetBkColor(hItem, EDIT_CI_DISABLED, GUI_MAKE_COLOR(0xF0F0F0));
    //
    // Set transparency
    //
    WM_SetHasTrans(hWin);
...
void MainTask(void) {
  ...
  //
  WM_CreateWindowAsChild(0, 0, 1, 1, WM_HBKWIN, 0, _cbAnimation, 0);
  //
  // Animation loop
  //
  while (1) {
    hWin = GUI_CreateDialogBox(_aDialogOrder, GUI_COUNTOF(_aDialogOrder), &_cbDialogOrder, WM_HBKWIN, 0, 0); 
    GUI_MEMDEV_MoveInWindow(hWin, 00, 0, -90, 500);
    WM_MakeModal(hWin);
    GUI_ExecCreatedDialog(hWin);
    GUI_Delay(500);
  }
