...
static GUI_CONST_STORAGE GUI_BITMAP _bmRect_60x60 = {
  60,                                 // XSize
  60,                                 // YSize
  60,                                 // BytesPerLine
...
static void _cbBk(WM_MESSAGE * pMsg) {
  ...
  case WM_PAINT:
    ...
    GUI_DispStringHCenterAt("Radial Menu with Motion Support", xSize / 2, 5);
    break;
  }
}
...
static void _cbDraw(WM_MESSAGE * pMsg) {
  ...
  case WM_PAINT:
    ...
    if (pPara->xSizeItem == 0) {
      ...
      pPara->ry          = ((pPara->ySizeWindow - 30) - pPara->ySizeItem) / 2;
    ...
    #if 0
      //
      // Please leave for test purpose
      //
      GUI_DrawRect(pPara->mx - pPara->rx, pPara->my - pPara->ry, pPara->mx + pPara->rx, pPara->my + pPara->ry);
      GUI_DrawRect(0, 0, pPara->xSizeWindow - 1, pPara->ySizeWindow - 1);
      GUI_DrawHLine(pPara->my, pPara->mx - 5, pPara->mx + 5);
      GUI_DrawVLine(pPara->mx, pPara->my - 5, pPara->my + 5);
    #endif
    break;
  }
}
...
static void _CreateCheckbox(PARA * pPara) {
  ...
  //
  hCheck = CHECKBOX_CreateUser((xSize - 220) / 2, ySize - 30, 220, 20, WM_HBKWIN, WM_CF_SHOW | WM_CF_HASTRANS, 0, GUI_ID_CHECK0, sizeof(pPara));
  CHECKBOX_SetUserData(hCheck, &pPara, sizeof(pPara));
  CHECKBOX_SetTextColor(hCheck, GUI_WHITE);
  CHECKBOX_SetFont(hCheck, &GUI_FontRounded22);
  CHECKBOX_SetText(hCheck, "Automatic animation");
