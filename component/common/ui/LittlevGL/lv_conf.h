...
#else       /*LV_MEM_CUSTOM*/
#define LV_MEM_CUSTOM_INCLUDE "platform_stdlib.h" /*Header for the dynamic memory function*/
...
#define LV_HOR_RES          (480)//(320)
#define LV_VER_RES          (272)//(240)
#define LV_DPI              100
...
#if LV_TICK_CUSTOM == 1
#define LV_TICK_CUSTOM_INCLUDE  "ameba_soc.h"        /*Header for the sys time function*/
