...
#ifndef PNP_MEMORY_COMPONENT_H
#define PNP_MEMORY_COMPONENT_H
...
typedef struct
{
  ...
  int32_t total_flash;
  int32_t total_sram;
  int32_t total_external_ram;
  int32_t remain_heap;
  bool telemetry_enable_remain_heap;
  int32_t telemetry_interval;
  int32_t telemetry_counter;
} pnp_memory_component;
