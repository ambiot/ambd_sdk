 ...
 *           app_gap_callback with cb_type @ref GAP_MSG_LE_READ_RSSI.
 *
 * @param[in] conn_id Connection ID
...
/**
  ...
  *           app_gap_callback with cb_type @ref GAP_MSG_LE_SET_DATA_LEN. And if data length was changed,
  *           app_gap_callback with cb_type @ref GAP_MSG_LE_DATA_LEN_CHANGE_INFO will be called.
  *
  * @param[in] conn_id Connection ID
...
/**
  ...
  *          If the phy used was changed, app_gap_callback with cb_type @ref GAP_MSG_LE_PHY_UPDATE_INFO will be called.
  *
  * @param[in] conn_id Connection ID
...
/**
  ...
  *             by  app_handle_conn_param_update_evt.
  *
  *         App can call this api to modify connection interval, latency and supervision timeout value.
  *
