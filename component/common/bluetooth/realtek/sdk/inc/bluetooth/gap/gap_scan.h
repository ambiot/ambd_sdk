...
/**
 * @brief   Start a device discovery scan. If device changes to scanning state, app_handle_dev_state_evt
 *          will be called. And the advertising data or scan response data will be returned by app_gap_callback
