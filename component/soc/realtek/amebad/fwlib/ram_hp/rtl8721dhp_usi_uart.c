 ...
 void USI_UARTStructInit(USI_UARTInitTypeDef* USI_UARTInitStruct)
{
	...
	USI_UARTInitStruct->USI_UARTRxTimeOutCnt = 64;
}
 ...
 void USI_UARTInit(USI_TypeDef* USIx, USI_UARTInitTypeDef *USI_UARTInitStruct)
{
	...
	assert_param(USI_UARTInitStruct->USI_UARTRxTimeOutCnt <= 0Xffff);
	...
	/*RX timeout counter*/
	USIx->UART_RXFIFO_TO_TH &= ~(USI_UART_RXFIFO_TO_TH);
	USIx->UART_RXFIFO_TO_TH = USI_UARTInitStruct->USI_UARTRxTimeOutCnt;
